 ...
 *
 * 展示右乘初等矩阵 = 列变换的几何效果。
 * 两个形状并排：A 的形状 → A·E 的形状，动画从单位形状过渡。
 */
...
const TRANSFORM_COLORS = [0x06d6a0, 0xef476f];  // A: green, AE: red (different from row scene)


export class Ch3R13ElemColRenderer extends SceneRenderer {
    ...
    buildScene(data) {
        ...
        this._addAnimControlUI('la_ch3r13_anim_auto');
